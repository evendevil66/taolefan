...
CREATE TABLE `orders`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 422 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `percentage`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '提成统计表 ' ROW_FORMAT = Dynamic;
